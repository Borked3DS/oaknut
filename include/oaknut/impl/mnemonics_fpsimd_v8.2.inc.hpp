...
{
    emitOp<"0001111011000010SSSSSSnnnnnddddd", "d", "n", "S">(rd, wn, 64 - fbits.value());
}
void SCVTF(HReg rd, XReg xn, ImmRange<1, 64> fbits)
{
    emitOp<"1001111011000010SSSSSSnnnnnddddd", "d", "n", "S">(rd, xn, 64 - fbits.value());
}
void SCVTF(HReg rd, WReg wn)
{
    emitOp<"0001111011100010000000nnnnnddddd", "d", "n">(rd, wn);
}
void SCVTF(HReg rd, XReg xn)
{
    emitOp<"1001111011100010000000nnnnnddddd", "d", "n">(rd, xn);
}
